...
class KafkaFulfillmentDomainEventTransportUnitExceptionTest {

    @Mock
    private KafkaTemplate<String, Object> kafkaTemplate;

    @InjectMocks
    private KafkaFulfillmentDomainEventTransport transport;

    @Test
    void 배송완료_전송이_비동기로_실패하면_예외가_발생한다() {
        // given
    ...
    @Test
    void 배송완료_전송이_동기로_실패해도_예외가_발생한다() {
        // given
        when(kafkaTemplate.send(anyString(), anyString(), any()))
