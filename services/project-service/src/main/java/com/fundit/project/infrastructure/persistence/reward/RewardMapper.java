...
class RewardMapper {
    ...
    Reward toDomain(RewardJpaEntity entity) {
        return Reward.builder()
                ...
                .earlyBirdDiscountType(entity.getEarlyBirdDiscountType())
                .earlyBirdDiscountValue(entity.getEarlyBirdDiscountValue())
    ...
    RewardJpaEntity toEntity(Reward domain) {
        return RewardJpaEntity.builder()
                ...
                .earlyBirdDiscountType(domain.getEarlyBirdDiscountType())
                .earlyBirdDiscountValue(domain.getEarlyBirdDiscountValue())
                .hasOption(domain.isHasOption())
                .sortOrder(domain.getSortOrder())
                .simpleRefundDisabled(domain.isSimpleRefundDisabled())
                .shippingFee(domain.getShippingFee())
                .estimatedDeliveryDays(domain.getEstimatedDeliveryDays())
