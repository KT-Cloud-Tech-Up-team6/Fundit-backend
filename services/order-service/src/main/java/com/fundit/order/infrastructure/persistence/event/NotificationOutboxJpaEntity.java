...
/** 단순 애그리거트 — notification.raised.v1 발행용 트랜잭셔널 아웃박스 행. */
@Getter
@Entity
@Builder
...
public class NotificationOutboxJpaEntity {
    ...
    public static final String TYPE_REWARD_RESTOCK = "REWARD_RESTOCK";
    public static final String TYPE_COUPON_EXPIRING = "COUPON_EXPIRING";
